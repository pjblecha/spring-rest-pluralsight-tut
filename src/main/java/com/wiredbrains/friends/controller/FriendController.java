...
public class FriendController {
    ...
    Iterable<Friend> findAll(@Nullable @RequestParam(value = "first", required = false) String firstName,
                             @Nullable @RequestParam(value = "last", required = false) String lastName) {
        if (firstName != null && lastName != null) return friendService.findByFirstNameAndLastName(firstName, lastName);
